...
class Currencies(API):
    def get_currencies(self, ids, interval = None, convert = None, status = None, filter = None, sort = None,
        ...
        '''
        https://nomics.com/docs/#tag/Currencies
        
        Returns price, volume, market cap, and rank for all currencies

        :param  str   ids:                      String or comma separated list of Nomics Currency IDs
                list                            to filter result rows.
    ...
    def get_metadata(self, ids = None, attributes = None):
        ...
        :param  [str]   attributes: Comma separated list of currency attributes to filter result columns
                                    Optional
        attributes=['id', 'original_symbol', 'name', 'description', 'website_url', 'logo_url', 'blog_url', 'discord_url', 'facebook_url',
    ...
    def get_sparkline(self, start = '2021-01-31T00:00:00Z', end = None, ids=None):
        '''
        ...
        :param  str start:  Start time of the interval in RFC3339 format. e.g. '2011-08-18T00:00:00Z'
